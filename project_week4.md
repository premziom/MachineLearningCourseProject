...
In the project, 2 classification models was created and the models are comparred in terms of predicting accuracy.
...
Summary
-------
Random Forrest classification gives a very good results for the classification. In the out of sample classification, the accuracy war 99%. It was much higher comparred to the Classification Tree. Therefore, the Random Forest Classification was chosen as a final model.
